<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="modify.aspx.cs" Inherits="ayzhuangxiu.houtai.cp.cl.modify" %>
                ...
                <ContentTemplate>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr height="40">
                            ...
                            <td>您现在的位置：<font color="DarkSlateGray"><b>栏管理</b></font>&nbsp;->&nbsp;编辑栏目&nbsp;&nbsp;←&nbsp;<a href="default.aspx">返回列表</a>
                            </td>
                            <td></td>
                        </tr>
                    </table>
                    ...
                    <table cellpadding='2' cellspacing='2' class='tab'>
                        ...
                        <tr>
                            ...
                            <td class="hback" colspan="3">
                                <asp:DropDownList ID="bParent" CssClass="dropdownlist" runat="server">
                                </asp:DropDownList>
                            </td>                          
                        </tr>
                        <tr>
