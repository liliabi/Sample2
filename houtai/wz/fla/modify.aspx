<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="modify.aspx.cs" Inherits="ayzhuangxiu.houtai.wz.fla.modify" %>
                ...
                <ContentTemplate>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr height="40">
                            ...
                            <td>您现在的位置：<font color="DarkSlateGray"><b>网站信息</b></font>&nbsp;->&nbsp;首页幻灯片&nbsp;&nbsp;->&nbsp;编辑图片&nbsp;&nbsp;←&nbsp;<a href="default.aspx">返回列表</a>
                            </td>
                            <td></td>
                        </tr>
                    </table>
                    ...
                    <table cellpadding='2' cellspacing='2' class='tab'>
                            ...
                            <td colspan="3" class="hback">
                                <table border="0" cellpadding="3" cellspacing="0">
                                    <tr>
                                        ...
                                        <td>
                                            <iframe src="../../../inc/ay_upload.aspx?fd=bPic" frameborder="0" style="height: 25px; width: 400px;"
                                                scrolling="no"></iframe>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            <td valign="top" class="hback_1">描述：
                            </td>
                            <td colspan="3" class="hback">
