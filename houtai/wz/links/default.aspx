<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ayzhuangxiu.houtai.wz.links._default" %>
                ...
                <ContentTemplate>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr height="40">
                            ...
                            <td>您现在的位置：<font color="DarkSlateGray"><b>网站信息</b></font>&nbsp;->&nbsp;友情链接&nbsp;&nbsp;<a href="default.aspx">[刷新列表]</a>&nbsp;<a
                                href="add.aspx">[增加]</a>
                            </td>
                            <td>&nbsp;
                            </td>
