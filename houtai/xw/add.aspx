<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add.aspx.cs" Inherits="ayzhuangxiu.houtai.xw.add" %>
                ...
                <ContentTemplate>   
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr height="40">
                            ...
                            <td>您现在的位置：<font color="DarkSlateGray"><b>新闻管理</b></font>&nbsp;->&nbsp;新增新闻&nbsp;&nbsp;←&nbsp;<a href="default.aspx">返回列表</a>
                            </td>
                            <td></td>
                        </tr>
                    </table>
