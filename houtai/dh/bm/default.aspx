<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ayzhuangxiu.houtai.dh.bm._default" %>
                ...
                <ContentTemplate>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr height="40">
                            ...
                            <td>您现在的位置：<font color="DarkSlateGray"><b>导航管理</b></font>&nbsp;->&nbsp;底部菜单&nbsp;&nbsp;<a href="default.aspx">[刷新列表]</a>&nbsp;<a
                                href="add.aspx">[增加]</a>
                            </td>
                            <td>&nbsp;
                            </td>
                        ...
                        <asp:Repeater ID="rpList" runat="server">
                            <ItemTemplate>
                                <tr class="<%#(Container.ItemIndex%2==0)?"even":"odd"%>" onmouseover="highlightRows(this,'<%#(Container.ItemIndex%2==0)?"even":"odd"%>')"
                                    ...
                                    <td align="center"><%#Eval("bUrl")%></td>
                                    <td align="center"><%#Eval("bOpenModeName")%></td>
                                    <td align="center"><%#Eval("bIsShowName")%></td>
                                    <td align="center"><%#Eval("bOrder")%></td>
                                    <td align="center">
                                        <asp:HiddenField ID="bId" runat="server" Value='<%# Eval("bId").ToString()%>' />
                                        <asp:HyperLink ID="btnEdit" CssClass="icon icon-edit" runat="server" NavigateUrl='<%# "modify.aspx?id=" + Eval("bId")%>' Text="编辑"></asp:HyperLink>
                    ...
                    <table cellspacing="1" cellpadding="1" style="width: 100%;" align="center">
                        <tr>
                            <td align="left" height="40">
                                <asp:Button ID="btnBatchDeleted" runat="server" CssClass="buttonblue" Text="批量删除" OnClientClick="return confirm('确认要删除吗?');" OnClick="btnBatchDeleted_Click" />
                            </td>
                        </tr>
                    </table>
                </ContentTemplate>
