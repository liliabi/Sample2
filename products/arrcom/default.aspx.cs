...
namespace ayzhuangxiu.products.arrcom
{
    public partial class _default : System.Web.UI.Page
    {
        ...
        private void BindDataList()
        {
            ...
            string sql = "select a.* from ay_products_v a where (a.bClassID in (select bId from ay_prodclass where bParent=34) or a.bParentID in (select bId from ay_prodclass where bParent=34)) ";
            if (classid != "")
            {
