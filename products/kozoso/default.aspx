<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ayzhuangxiu.products.kozoso._default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="MainBox">
            <div class="banner_list b_dlock" style="background: url(/upfile/kozoso.png) center top no-repeat; display: block;">
            </div>
        </div>
        <div class="inside_dh">
            <div class="container">
